...
curl_delete "$ELASTICSEARCH_URL/demo-reindex*"
curl_delete "$ELASTICSEARCH_URL/demo-alias*"
curl_delete "$ELASTICSEARCH_URL/_index_template/demo-alias"
curl_delete "$ELASTICSEARCH_URL/_ingest/pipeline/demo-reindex"
